...
#
# Generated by Vivado on Wed Apr 03 18:49:21 CEST 2024
...
#
#    "/data/riscv/jtag_debug/jtag_debug_top/jtag_debug.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
#    "/data/riscv/jtag_debug/hdl/src/config_pkg.sv"
#    "/data/riscv/jtag_debug/hdl/src/arty_pkg.sv"
#    "/data/riscv/jtag_debug/jtag_debug_top/jtag_debug.srcs/sources_1/new/debug_pkg.sv"
#    "/data/riscv/jtag_debug/jtag_debug_top/jtag_debug.srcs/sources_1/new/top.sv"
#    "/data/riscv/jtag_debug/jtag_debug_top/jtag_debug.srcs/constrs_1/new/ARTY.xdc"
#    "/data/riscv/jtag_debug/jtag_debug.srcs/utils_1/imports/synth_1/top.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/jtag_debug_top/jtag_debug.srcs/sources_1/new/debug_pkg.sv"]"\
 ...
 "[file normalize "$origin_dir/jtag_debug.srcs/utils_1/imports/synth_1/top.dcp"]"\
  ]
  foreach ifile $files {
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../can-clic/pynq-z1/board_files"]" -objects $obj
...
set_property -name "target_constrs_file" -value "[get_files [list "*new/ARTY.xdc"]]" -objects $obj
set_property -name "target_part" -value "xc7a35ticsg324-1L" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*new/ARTY.xdc"]]" -objects $obj
...
set_property -name "incremental_checkpoint" -value "$proj_dir/jtag_debug.srcs/utils_1/imports/synth_1/top.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/jtag_debug.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/jtag_debug.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/jtag_debug.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
