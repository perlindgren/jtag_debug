...
# create_clock -period 50.000 -name TCK -waveform {0.000 25.000} [get_pins u_bscane2/TCK]
# create_clock -period 50.000 -name DCRK -waveform {0.000 25.000} [get_pins u_bscane2/DCRK]
